...
export default function Header() {
  ...
  return (
    <div className='relative flex justify-center h-fit mx-auto pt-2 gap-2 px-4 w-full shadow-lg py-2 rounded-xl'>
      {image && <img alt='logo' src={`uploads/${image}`} className={`absolute rounded-full right-4 w-8 md:w-12 lg:w-16 h-14`} />}
